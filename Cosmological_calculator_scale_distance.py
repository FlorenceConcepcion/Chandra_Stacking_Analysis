"""
Code for cosmological calculator, website:
http://www.astro.ucla.edu/~wright/CosmoCalc.html

I have made two functions from it, return_scale and lum_distance, 
which take input redshift and return the scale kpc/" 
and the luminsoity distance in Mpc
...
# re-define params from website
H0 = 69.6                       # Hubble constant
WM = 0.286                      # Omega(matter)


def return_scale(z, H0 = H0, WM = WM):			# input redshift
	"""The function, given a redshift value, 
	returns the scale of kpc/"
	"""
	...
	return '%.2f' % kpc_DA 		#units of kpc/"

def lum_distance(z, H0 = H0, WM = WM):			# input redshift
	"""The function, given a redshift value, 
	...
	return '%1.1f' % DL_Mpc 	 # units of Mpc
